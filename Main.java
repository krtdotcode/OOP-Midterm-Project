...
// Display all Dentists
   private static void displayDentists() {
       ...
       for (int i = 0; i < dentists.size(); i++) {
           ...
           System.out.printf("%-5s %-20s %-15s %-25s %.2f%%\n",
               String.format("%04d", i + 1), // Dentist IDs in XXXX format
               dentist.getName(), dentist.getContactNumber(), dentist.getAddress(), dentist.getCommissionRate() * 100);
       }
       System.out.println("---------------------------------------------------------------------------------");
   }
   // Display all Clients
   private static void displayClients() {
       ...
       for (int i = 0; i < clients.size(); i++) {
           ...
           System.out.printf("%-10s %-20s %-15s %-25s %d\n",
               client.getRegistrationYear() + "-" + String.format("%04d", i + 1), // Client IDs in YEAR-XXXX format
   ...
   private static void addTransaction() {
       ...
       while (true) {
           int serviceIndex = getIntInput("Select a service by number (1-" + services.size() + ") or 0 to finish: ") - 1;
