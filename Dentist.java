...
public class Dentist extends Person {
	...
	// Constructor
	public Dentist(String name, int contactNumber, String address, double commissionRate) {
	...
	public void updateDentistInfo(String name, int contactNumber, String address, Double commissionRate) {
